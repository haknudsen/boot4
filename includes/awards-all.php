...
if ( $result->num_rows > 0 ) {
    ...
    while ( $row = $result->fetch_assoc() ) {
        ...
        echo( '<li class="media"' );
        echo PHP_EOL;
        echo( '     <a href="#" data-toggle="tooltip" title="' . $alt . '"> <img class="card-img-top award d-block justify-content-center" src="http://websitetalkingheads.com/images/' . $name . '.png"  alt="' . $alt . '" /> </a>' );
        echo PHP_EOL;
